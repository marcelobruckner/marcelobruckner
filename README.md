...
- Projetos backend Java com foco em APIs, segurança e integração.
- Laboratórios de OpenShift, Kubernetes, Tekton e automação de deploy.
- Estudos práticos de Keycloak, OIDC, mensageria e cloud.
- Materiais de apoio e repositórios de aprendizado técnico.
